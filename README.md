...
# Screenshots
1) In the first image, you can see the interface that allows you to create an item monitoring application.
2) In the second image, you can see the matching items. The buttons on the right allow you to:
    • Ignore order
    • Go to Train Trade page
    • View details
    • Create a purchase message
<p align="center">
